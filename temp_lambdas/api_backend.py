    ...
    try:
        ...
        if path == "/products" and method == "GET":
            ...
            try:
                ...
                print(f"DB Error, using fallback: {db_err}")
                return response(200, [
                    {"id": "1", "nombre": "AWS IoT Button", "precio": 19.99, "categoria": "Hardware", "imagen_url": "https://images.unsplash.com/photo-1518770660439-4636190af475?w=400&q=80"},
                    {"id": "2", "nombre": "Serverless Framework Book", "precio": 45.00, "categoria": "Libros", "imagen_url": "https://images.unsplash.com/photo-1532012197267-da84d127e765?w=400&q=80"},
                    {"id": "3", "nombre": "Cloud Architecture Poster", "precio": 12.50, "categoria": "Accesorios", "imagen_url": "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=400&q=80"}
                ])
            ...
            try:
                ...
                # Simulate async payment completion after a few seconds for frontend validation
                return response(200, {'status': 'completed', 'mock': True})
            ...
            try:
                ...
                return response(200, {"status": "processed", "mock": True})
            ...
            try:
                ...
                return response(200, [
                    {"created_at": "2026-05-12T04:15:00", "lambda_name": "processor-lambda", "message": "Simulated DB connection error (cryptography missing)."}
                ])
